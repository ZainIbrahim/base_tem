...
<head>
    ...
    <title>Sign In - Base App - Admin &amp; Dashboard Template</title>
                            ...
                            <div class="card-body">
                                <div class="m-sm-4">
                                    <div class="text-center">
                                        <img src="../assets/img/avatars/avatar.jpg" alt="Chris Wood" class="img-fluid rounded-circle" width="132" height="132" />
                                    </div>
                                    <form id="frm_login" method="post" action="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-lg" type="text" name="user_name" id="user_name" placeholder="Enter your username" />
                                        </div>
                                        <div class="form-group">
